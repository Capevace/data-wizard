...
class MedianDurationChart extends ChartWidget
{
    ...
    {
        [$strategies, $datasets] = $this->groupDataByStrategy(fn (ExtractionRun $run) => $run->duration->totalSeconds, method: 'median');
