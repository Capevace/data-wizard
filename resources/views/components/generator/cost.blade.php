...
<div {{ $attributes->class('grid grid-cols-2 gap-2') }}>
    <x-generator.key-value icon="heroicon-o-currency-euro" label="Tokens">
        <span class="text-lg">{{ $stats->tokens }}</span>
    </x-generator.key-value>

    <x-generator.key-value icon="heroicon-o-currency-euro" label="Total Cost">
        <span class="text-lg">{{ $stats->calculateTotalCost()?->format() ?? '–' }}</span>
    </x-generator.key-value>

    <x-generator.key-value icon="heroicon-o-currency-euro" label="Input Tokens">
        <span class="text-lg">{{ $stats->inputTokens }}</span>
    </x-generator.key-value>

    <x-generator.key-value icon="heroicon-o-currency-euro" label="Input Cost">
    ...
    <x-generator.key-value icon="heroicon-o-currency-euro" label="Output Tokens">
        <span class="text-lg">{{ $stats->outputTokens }}</span>
    </x-generator.key-value>

    <x-generator.key-value icon="heroicon-o-currency-euro" label="Output Cost">
